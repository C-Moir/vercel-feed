...
// CT logs — Google Argon/Xenon only.
// Cloudflare Nimbus was tried but is biased toward pages.dev and workers.dev
// (Cloudflare logs their own certs there first), which flooded those two planets
// and starved every other platform. Google's logs are more balanced across CAs.
// Per-platform coverage is handled by the crt.sh supplement below.
const CT_LOGS = [
